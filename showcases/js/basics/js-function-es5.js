...
// 检测对象是否有哪个类名
    ...
    // <img id="b2" class="imgb2 haha oo"></img>
...
//添加类名 
    ...
    //if的条件是一个数组，else是单个的getElementById
    //这里删除了源文件的(this.istype(obj,'array') || this.istype(obj,'element')) &&在 if的条件里面


//删除类名 (this.istype(obj, 'array') || this.istype(obj, 'elements')) &&
...
//获取兄弟节点
    ...
    //node.type === 1 , An Element node like <p> or <div>.
...
//适配rem
    //这个适配的方法很多，我就写我自己用的方法。大家也可以去我回答过得一个问题那里看更详细的说明！
